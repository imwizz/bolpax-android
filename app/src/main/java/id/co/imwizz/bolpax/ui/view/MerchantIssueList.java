    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(MerchantIssueList.this, "Home", Toast.LENGTH_SHORT).show();
            }
        });
        toolbar.setTitle("");
        ...
        issue=(ListView)findViewById(R.id.ListviewIssue);
...
//                issue = (IssueList) parent.getItemAtPosition(position);
                ...
                Intent myIntent = new Intent(MerchantIssueList.this, BuyerIssueDetailActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId())
        {
            ...
            case R.id.create_store:
                Intent i2 = new Intent(MerchantIssueList.this, MerchantHomeActivity.class);
